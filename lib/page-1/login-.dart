              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(93*fem, 0*fem, 101*fem, 36.5*fem),
                    width: double.infinity,
                    child: Center(
                      // maskgroupuyM (1:39)
                      child: SizedBox(
                  ...
                  Center(
                    ...
                    child: Container(
                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4*fem, 24.5*fem),
                      child: RichText(
                        textAlign: TextAlign.center,
                        text: TextSpan(
                          style: SafeGoogleFont (
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 7*fem, 30.5*fem),
                    width: 275*fem,
                    height: 64.5*fem,
                    child: Stack(
                      children: [
                        Positioned(
                          // textfieldchange7G7 (1:43)
                          left: 0*fem,
                          top: 0*fem,
                          child: TextButton(
                            onPressed: () {},
