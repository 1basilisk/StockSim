      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // statusbarQdq (1:140)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 9*fem, 18.5*fem),
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(23*fem, 0*fem, 30*fem, 34*fem),
              width: double.infinity,
              height: 78.5*fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
            ...
            Container(
              // group13MHV (1:248)
              margin: EdgeInsets.fromLTRB(28*fem, 0*fem, 36*fem, 29.43*fem),
              width: double.infinity,
              height: 40*fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
            ...
            Container(
              // group14QHh (1:149)
              margin: EdgeInsets.fromLTRB(21*fem, 0*fem, 29*fem, 22.5*fem),
              width: double.infinity,
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0.5*fem, 0*fem, 10*fem, 27.43*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                          ...
                          child: Stack(
                            children: [
                              Positioned(
                                ...
                                top: 0*fem,
                                child: Container(
                                  padding: EdgeInsets.fromLTRB(15*fem, 10*fem, 195*fem, 10*fem),
                                  width: 334*fem,
                                  height: 65*fem,
                                  decoration: BoxDecoration (
                          ...
                          child: Stack(
                            children: [
                              Positioned(
                                ...
                                top: 0*fem,
                                child: Container(
                                  padding: EdgeInsets.fromLTRB(15*fem, 10*fem, 178*fem, 10*fem),
                                  width: 334*fem,
                                  height: 64.67*fem,
                                  decoration: BoxDecoration (
                                    borderRadius: BorderRadius.circular(12*fem),
